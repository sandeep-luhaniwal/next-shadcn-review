    ...
    return (
        <div className='bg-[url("/images/webp/hero-bg.webp")] bg-cover object-cover pb-1 relative overflow-clip'>
            ...
            <div className="max-w-[1240px] relative z-30 mx-auto px-4 xl:px-0 pt-14 md:pt-16 lg:pt-[75px]">
                <h1 className='max-w-[863px] mx-auto text-3xl md:text-[40px] lg:text-[46px] xl:text-[50px] font-medium text-center !font-inter'>Get Verified Reviews for Your Book or Product or Earn by Writing Them.</h1>
