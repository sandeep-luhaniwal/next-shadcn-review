    ...
    return (
        <div className="grid grid-cols-1 gap-6">
            <div className="flex flex-col gap-0.5">
                <h2 className="text-lg md:text-xl lg:text-[22px] xl:text-2xl font-semibold">Post a Job</h2>
                <span className="text-sm text-black/65">Create a new review job and connect with qualified reviewers.</span>
            </div>
            <Card>
                <CardHeader>
